...
(function () {
  ...
  Util.inBounds = function (pos) {
    ...
    if (pos[0] > GnG.Game.dim_x()) { return false; }
    if (pos[1] > GnG.Game.dim_y()) { return false; }
    return true;
  };

  Util.offScreen = function (obj) {
    if (obj.pos[0] < 0 || obj.pos[0] > GnG.Game.dim_x()) // GnG.Game.DIM_X)
      { return true; }
    if (obj.pos[1] < 0 || obj.pos[1] > GnG.Game.dim_y() + 100) // GnG.Game.DIM_Y)
      { return true; }
    return false;
  };
